    ...
    edoEstatus.map(edo => {
      ...
      if(svgNode !== undefined){
        switch(edoCalif){
          ...
          break;
          case 2:
            svgNode.style.fill = "#FFB062";
          break;
          case 3:
            svgNode.style.fill = "#FFE849";
          break;
          case 4:
            svgNode.style.fill = "#8DDA70";
          break;
          default: svgNode.style.fill = "#FF7E7C";
        }
